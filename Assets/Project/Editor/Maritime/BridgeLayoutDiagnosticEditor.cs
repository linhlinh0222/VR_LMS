...
namespace MaritimeLMS.LessonsEditor
{
    ...
    {
        // v6: bumped after Phase 21 polish (LMS_UI_Canvas disabled,
        // skybox set) for fresh diagnostic.
        private const string SessionStateKey = "MaritimeLMS.LayoutDiagRan.v6";
